  ...
  const platforms = [
    {
      ...
      pre: t("downloadOn"),
      name: "App Store",
      href: "https://download.terminal.free/cdn/mobile/mt5/ios?server=RocoBroker-Ltd",
    },
    {
      key: "android",
      Icon: PlayIcon,
      pre: t("getItOn"),
      name: "Google Play",
      href: "https://download.terminal.free/cdn/mobile/mt5/android?server=RocoBroker-Ltd",
    },
    {
      key: "windows",
      Icon: WindowsIcon,
    ...
    },
    {
      ...
      pre: t("web"),
      name: t("terminal"),
      href: "https://webtrading.rocobroker.com/terminal?utm_source=www.rocobroker.com&mode=demo&lang=en&theme-mode=0&theme=greenRed",
    },
  ];
